...
const ingredientDetails = [
  {
    name: "Triptófano",
    image: "media/ingredients/triptofano.png",
  ...
  },
  {
    ...
    image: "media/ingredients/alfa-lipoico.png",
  ...
  {
    name: "Acido cítrico",
    image: "media/ingredients/gaba.png",
  ...
  {
    name: "Acido fólico",
    image: "media/ingredients/magnesio.png",
  ...
  },
  {
    name: "Coenzima Q10",
    image: "media/ingredients/magnesio.png",
    description: "Conocido como un mineral anti-estrés. Es un tranquilizante natural que relaja los músculos y regula la función normal del sistema nervioso central."
  },
  {
    name: "Magnesio",
    image: "media/ingredients/magnesio.png",
  ...
  },
  {
    name: "Sucralosa",
    image: "media/ingredients/magnesio.png",
    description: "La sucralosa es, en palabras simples, un sustituto del azúcar tradicional que proviene de esta a través de un proceso de modificación de la molécula original. No contiene calorías, lo cual se presenta como una solución definitiva al uso de azúcar añadida en productos procesados. Beneficios: Este edulcorante no reduce los niveles de azúcar en la sangre y reduce significativamente la cantidad de calorías consumidas en comparación con el azúcar. Es por eso que es una alternativa común y efectiva para satisfacer el gusto por lo dulce sin comprometer la salud y la dieta."
  },
  {
    name: "Te verde",
    image: "media/ingredients/magnesio.png",
